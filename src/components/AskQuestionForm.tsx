  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({ ...form, type: "question" }),
      });
    ...
    <form onSubmit={handleSubmit} noValidate className="space-y-8">
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div>
          ...
          />
          {errors.name && (
            <p id="ask-name-error" className="mt-2 text-xs text-red-400">
              {errors.name}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.email && (
            <p id="ask-email-error" className="mt-2 text-xs text-red-400">
              {errors.email}
            </p>
          )}
        </div>
      ...
      <div>
        ...
        />
        {errors.message && (
          <p id="ask-message-error" className="mt-2 text-xs text-red-400">
            {errors.message}
          </p>
        )}
      </div>
